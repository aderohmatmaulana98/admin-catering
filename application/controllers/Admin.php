...
class Admin extends CI_Controller
{
    ...
    public function produk_by_paket($id)
    {
        ...
        $ch1 = curl_init();
        curl_setopt($ch1, CURLOPT_FOLLOWLOCATION, true);
        curl_setopt($ch1, CURLOPT_URL, "localhost:8000/api/produk/paket_id/$id");
        curl_setopt($ch1, CURLOPT_HTTPHEADER, array('Content-Type: application/json', $authorization));
        curl_setopt($ch1, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch1, CURLOPT_COOKIEJAR, 'cookie-name.txt');
        curl_setopt($ch1, CURLOPT_COOKIEFILE, 'cookie-name.txt');
    ...
    public function status()
    {
        ...
        $ch1 = curl_init();
        curl_setopt($ch1, CURLOPT_FOLLOWLOCATION, true);
        curl_setopt($ch1, CURLOPT_URL, "localhost:8000/api/status");
        curl_setopt($ch1, CURLOPT_HTTPHEADER, array('Content-Type: application/json', $authorization));
        curl_setopt($ch1, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch1, CURLOPT_COOKIEJAR, 'cookie-name.txt');
        curl_setopt($ch1, CURLOPT_COOKIEFILE, 'cookie-name.txt');
    ...
    public function insert_status()
    {
        ...
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_FOLLOWLOCATION, true);
        curl_setopt($curl, CURLOPT_URL, "localhost:8000/api/status");
        curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json', $authorization));
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($post));
    ...
    public function delete_status($id)
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "localhost:8000/api/status/$id");
        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json', $authorization));
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "DELETE");
        $result = curl_exec($ch);
        curl_close($ch);
